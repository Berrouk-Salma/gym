                   ...
                   <?php if(isset($activities) && !empty($activities)): ?>
                       <?php foreach($activities as $activity): ?>
                           <tr class="text-gray-300">
                               <td class="px-6 py-4"><?= htmlspecialchars($activity['idActivite']) ?></td>
                               <td class="px-6 py-4"><?= htmlspecialchars($activity['nom']) ?></td>
                               <td class="px-6 py-4"><?= htmlspecialchars($activity['description']) ?></td>
                               <td class="px-6 py-4"><?= htmlspecialchars($activity['capacite']) ?></td>
                               ...
                               <td class="px-6 py-4">
                                   <span class="px-2 py-1 rounded-full text-sm <?= $activity['Disponiblite'] > 0 ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' ?>">
                                       <?= htmlspecialchars($activity['Disponiblite']) ?>
                                   </span>
                               </td>
                               <td class="px-6 py-4">
